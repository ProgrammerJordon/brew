$.fn.autoNumeric = function () {
    if (!this || !this[0] || !this[0].id) return;
    return AutoNumeric.getAutoNumericElement(`#${this[0].id}`);
};

$.fn.getNumber = function () {
    const numericElement = $(this).autoNumeric();
    return numericElement ? numericElement.getNumber() : null;
};

$.fn.setNumber = function (value) {
    const numericElement = $(this).autoNumeric();
    if (numericElement) {
        numericElement.set(value);
    }
};
