...
public class BrewSessionCookieUtil {
    /**
    ...
    public static void setCookie(HttpServletResponse response, String cookieNm, String cookieVal)
        ...
        // 쿠키생성
        Cookie cookie = new Cookie(BrewWebUtil.removeCRLF(cookieNm), BrewWebUtil.removeCRLF(cookieValue));
    ...
    public static void setCookie(HttpServletResponse response, String cookieNm) throws UnsupportedEncodingException {
        ...
        // 쿠키생성 - 쿠키의 이름, 쿠키의 값
        Cookie cookie = new Cookie(BrewWebUtil.removeCRLF(cookieNm), null);
