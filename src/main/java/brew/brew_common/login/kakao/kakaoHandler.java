package brew.brew_common.login.kakao;
...
public class kakaoHandler {
    ...
    public void test() throws JsonProcessingException {
        // access token 지정
        apiHelper.setAccessToken("519641b3498e924b63e98232dbc2471e");

        // 푸시 알림이나 유저 아이디 리스트가 필요할 때 설정 합니다.
        // (디벨로퍼스 내에 앱설정 메뉴를 가시면 있습니다)
        apiHelper.setAdminKey("b8f7cd14bf9bd044faa87c3ac241784c");
    ...
    public void testUserManagement() throws JsonProcessingException {
